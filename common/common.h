...
#define		PROG_START	$F000		// Start of program image in flash memory. Ends at $FDFF
...
//#define		PROG_START_FOR_BSL		$E000	// Would be used temporarily while changing to a BSL
										//	that loads an 8K image