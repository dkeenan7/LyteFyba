...
//#define		PROG_START_FOR_BSL		$E000	// Would be used temporarily while changing to a BSL that
			...
			ORG		$100A			; Stay away from manufacturer supplied data
			; Calibration data
...
infoCellRes		ds		2			; High temperature cell internal resistance in micro-ohms
infoBoltPlCal	ds		2			; Not used here; retain for data compatibility
