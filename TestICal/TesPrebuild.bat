...
REM Now pass control to the batch file that creates the two files:
REM SVNrev.h with the SVN revision for the whole repository and 
REM ..\common\BSLrev.h with the SVN revision specifically for BSL2.s43
