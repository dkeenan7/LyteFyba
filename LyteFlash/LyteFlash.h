// LyteFlash.h : main header file for the LyteFlash application
//
#pragma once
...
// CLyteFlashApp:
// See LyteFlash.cpp for the implementation of this class
//

class CLyteFlashApp : public CWinApp
{
public:
	CLyteFlashApp();
